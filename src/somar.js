...
// **deve ser considerado como 0**. Além disso, **a função não deve retornar valores de tipos inesperados 
// (como NaN ou undefined)**, e deve tratar casos em que os **parâmetros não são números**, 
// retornando a mensagem "Parâmetro inválido".
